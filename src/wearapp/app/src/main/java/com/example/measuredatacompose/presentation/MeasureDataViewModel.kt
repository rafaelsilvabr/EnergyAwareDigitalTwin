...
class MeasureDataViewModel(
    ...
    init {
        viewModelScope.launch {
            ...
            val passiveSupported = healthServicesRepository.hasPassiveCapabilities()
...
//        // Crie um manipulador na thread principal
//        val handler = Handler(Looper.getMainLooper())
//
//        // Crie um Runnable que chama o método onClick do botão
//        val runnable = object : Runnable {
//            override fun run() {
//                // Chame o método onClick do botão aqui
//                toggleEnabled()
//
//                // Repita isso a cada 30 segundos (ou qualquer intervalo de tempo que você desejar)
